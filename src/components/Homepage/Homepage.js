            ...
            <Container className=' yes mt-5 d-flex justify-content-evenly '>
                <Container>
                        ...
                        <Button variant="secondary hire" ><Link to="/contact"><span className='hire-span text-white'>Hire Me</span></Link></Button>
                            <Button variant="secondary" className='cv'><a href="https://drive.google.com/file/d/1mqX0YGXc0c_emS-aQSjEmi182sL3C971/view?usp=sharing" target="_blank" rel="noreferrer"><span className='resume'>Resume</span></a></Button>
                    </Container>
                </Container>
